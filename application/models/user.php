...
class User extends CI_Model
{
	...
	{
		return $this->db->query("SELECT u.id, u.first_name, u.last_name, u.email, CASE u.level WHEN 9 THEN 'Admin' WHEN 5 THEN 'Host' WHEN 4 THEN 'User' END AS level, u.description, DATEDIFF(NOW(), u.created_at) AS days, i.file_path FROM users u JOIN images i ON u.image_id = i.id ORDER BY u.id DESC;")->result_array();
	}
